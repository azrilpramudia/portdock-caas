...
export default function CTASection() {
  return (
    <section className="py-12 px-6 bg-[#f8fafc]/50 dark:bg-[#020617] pb-24 transition-colors duration-300">
      <div className="max-w-6xl mx-auto relative overflow-hidden bg-gradient-to-r from-blue-50/80 to-blue-100/50 dark:from-blue-900/20 dark:to-blue-800/10 rounded-3xl border border-blue-100/50 dark:border-blue-900/50 shadow-sm p-12 md:p-16 flex flex-col md:flex-row items-center justify-center gap-12 transition-colors duration-300">
        ...
        <div className="hidden md:flex relative w-48 h-48 items-center justify-center">
          ...
          <div className="absolute bottom-4 left-4 w-16 h-12 bg-white/60 dark:bg-slate-800/60 rounded-full blur-md transition-colors"></div>
          <div className="absolute bottom-0 right-0 w-24 h-16 bg-white/80 dark:bg-slate-800/80 rounded-full blur-md transition-colors"></div>
        </div>

        {/* Text Content */}
        <div className="text-center md:text-left flex flex-col items-center md:items-start max-w-xl z-10">
          <h2 className="text-3xl md:text-[2rem] font-bold mb-4 text-[#0f172a] dark:text-white tracking-tight transition-colors">
            Ready to Deploy Your Application?
          </h2>
          <p className="text-slate-600 dark:text-slate-300 text-[15px] mb-8 leading-relaxed transition-colors">
