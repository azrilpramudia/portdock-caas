...
export default function HeroSection() {
  return (
    <section className="relative min-h-[100dvh] flex items-center pt-24 pb-16 overflow-hidden bg-linear-to-br from-white via-blue-50/40 to-white">
...
function HeroBadge() {
  return (
    <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-100 rounded-full px-4 py-1.5">
      ...
      <span className="text-sm font-medium text-blue-700">Docker Deployment Made Simple</span>
    </div>
  );
}
  ...
  return (
    <div className="flex items-center gap-6 flex-wrap pt-2">
      {TRUST_BADGES.map((item) => {
        ...
        return (
          <div key={item.label} className="flex items-center gap-1.5 text-sm text-gray-500">
