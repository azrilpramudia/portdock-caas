...
export default function TestimonialSection() {
  return (
    <section className="py-24 px-6 bg-white dark:bg-[#020617] transition-colors duration-300" id="testimonials">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {LANDING_TESTIMONIALS.map((testimonial, index) => (
            <div 
              key={index} 
              className="bg-white dark:bg-[#0f172a] rounded-2xl p-8 border border-slate-100 dark:border-slate-800 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none hover:-translate-y-1 transition-all duration-300"
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-bold text-[#0f172a] dark:text-white text-sm transition-colors">{testimonial.name}</h4>
