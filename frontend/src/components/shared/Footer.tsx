...
export default function Footer() {
  return (
    <footer className="bg-slate-950 dark:bg-background text-slate-300 py-16 px-6 border-t border-slate-800 dark:border-slate-800/80 transition-colors duration-300">
