...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300 overflow-hidden">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[100dvh] flex items-center pt-32 pb-20 overflow-hidden bg-gradient-to-br from-white via-blue-50/40 to-white dark:from-background dark:via-blue-950/20 dark:to-background transition-colors duration-300">
      ...
      <section className="py-24 px-6 bg-background transition-colors duration-300">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-bold text-foreground mb-6 transition-colors duration-300">Cerita Kami</h2>
              <div className="w-12 h-0.5 bg-blue-500/80 rounded-full mb-8"></div>
              <div className="space-y-6 text-muted-foreground leading-relaxed transition-colors duration-300">
                <p>
            ...
            <div className="relative">
              ...
              <div className="relative bg-card border border-border rounded-3xl p-10 shadow-xl shadow-blue-900/5 dark:shadow-none transition-colors duration-300">
                <div className="grid grid-cols-2 gap-6 text-center">
                  <div className="p-4">
                    ...
                    <div className="text-sm text-muted-foreground font-medium transition-colors duration-300">Aplikasi Terdeploy</div>
                  </div>
                  <div className="p-4">
                    <div className="text-4xl font-extrabold text-blue-600 dark:text-blue-400 mb-2 transition-colors duration-300">99.9%</div>
                    <div className="text-sm text-muted-foreground font-medium transition-colors duration-300">Uptime Server</div>
                  </div>
                  <div className="p-4">
                    <div className="text-4xl font-extrabold text-blue-600 dark:text-blue-400 mb-2 transition-colors duration-300">5k+</div>
                    <div className="text-sm text-muted-foreground font-medium transition-colors duration-300">Developer Aktif</div>
                  </div>
                  <div className="p-4">
                    <div className="text-4xl font-extrabold text-blue-600 dark:text-blue-400 mb-2 transition-colors duration-300">24/7</div>
                    <div className="text-sm text-muted-foreground font-medium transition-colors duration-300">Support Teknis</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Core Values */}
      <section className="py-24 px-6 bg-slate-50/50 dark:bg-background transition-colors duration-300">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground transition-colors duration-300">Nilai-Nilai Kami</h2>
            <div className="w-12 h-0.5 bg-blue-500/80 rounded-full mx-auto mt-6"></div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-card p-8 rounded-2xl border border-border shadow-sm dark:shadow-none hover:shadow-md transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3 transition-colors duration-300">Kesederhanaan</h3>
            ...
            <div className="bg-card p-8 rounded-2xl border border-border shadow-sm dark:shadow-none hover:shadow-md transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3 transition-colors duration-300">Reliabilitas</h3>
              <p className="text-muted-foreground leading-relaxed transition-colors duration-300">
            ...
            <div className="bg-card p-8 rounded-2xl border border-border shadow-sm dark:shadow-none hover:shadow-md transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3 transition-colors duration-300">Fokus pada Developer</h3>
              <p className="text-muted-foreground leading-relaxed transition-colors duration-300">
